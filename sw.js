const CACHE='ash-corridor-v26';
const ASSETS=['./','./index.html','./styles.css?v=11','./challenge-system.js?v=1','./combat-logic.js?v=15','./room-logic.js?v=1','./tower-data.js?v=1','./build-system.js?v=1','./skill-progression.js?v=1','./boss-mechanics.js?v=1','./ascension.js?v=1','./achievements.js?v=1','./arena-backgrounds.js?v=1','./pixel-art.js?v=14','./combat-visual-state.js?v=13','./game.js?v=18','./manifest.json'];
